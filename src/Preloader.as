package
{
	...
	public class Preloader extends MovieClip 
	{
		...
		public function Preloader() 
		{
			...
			//logger = Log.get//logger("Preloader");
		...
		private function ReadModsList(e:LoaderEvent):void
		{
			...
			var numSplitStrings:int = rawSplitStrings.length;	//SMLSE OPTIMIZE ATTEMPT
			for (var i:int = 0; i < numSplitStrings; ++i)
			{
		...
		private function StopPreloaderAndDisplayErrorMessage(errorMsg:String):void
		{
			...
			errorDisplay.wordWrap = true;
			errorDisplay.width = 480;
			errorDisplay.height = 700;
			errorDisplay.x = 0;
