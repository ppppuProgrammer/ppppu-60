package menu 
{
	...
	public class RGBAMenu extends Sprite
	{
		...
		private var sliders:Vector.<EditSlider> = new Vector.<EditSlider> ();
		...
		public function RGBAMenu(title:String = "") 
		{
			...
			for (var i:int = 0; i < 4; i++)
			{
				...
				var es:EditSlider = new EditSlider(sliderWidth, sliderHeight, textWidth, sliderRangesMin[i], sliderRangesMax[i], sliderRangesTick[i], sliderRangesValue[i]);
				sliders.push(es);
				addChild(es);
				es.x = labelWidth;
				es.y = yOffset;
		...
		private function handler(e:Event):void 
		{
			...
			var es:EditSlider = e.target as EditSlider;
