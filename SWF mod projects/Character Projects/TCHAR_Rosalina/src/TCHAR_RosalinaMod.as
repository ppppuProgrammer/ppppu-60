package
{
	...
	public class TCHAR_RosalinaMod extends TemplateCharacterMod 
	{
		...
		public function TCHAR_RosalinaMod() 
		{
			...
			animationPresets[animationPresets.length] = ["Cowgirl", 0, true, "Female (Standard)", true, "Male (Standard)", false, "Crown", false, "Left Earring", false, "Right Earring", false, "Left Eye Variant 2", 0, false, "Right Eye Variant 2", false, "Mouth Variant 2", false, "Rosalina Hair", false, "Body Variant 1"];
