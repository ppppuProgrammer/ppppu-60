...
dataForTimelineCreation.push(new ClosedSmileTimelineData().GetTimelineData());
		...
		private static function CreateShardModForEyeR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim4", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Right Eye var 2", false, "Put description here");
            return animateShard;
        }
		...
		private static function CreateShardModForMouth():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim4", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Mouth var 2", false, "Put description here");
            return animateShard;
        }
