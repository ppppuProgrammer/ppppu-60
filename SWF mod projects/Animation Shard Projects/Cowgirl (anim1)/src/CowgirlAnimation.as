...
dispInfo[dispInfo.length] = new DispObjInfo("PenisHighlight", 600, 0, "ShaftMask", DispObjInfo.FLAG_MASKED);
		...
		private function CreateShardModForMale():AnimateShardMod
		{
			...
			var maleAnimateShard:AnimateShardMod = new AnimateShardMod("Cowgirl", Vector.<String>(["Male", "Base", "Standard"]), timelineData, dispInfo, "Male (Standard)", true, "Male (Giver) animations for the Cowgirl position");
		...
		private function CreateShardModForFemale():AnimateShardMod
		{
			...
			var femaleAnimateShard:AnimateShardMod = new AnimateShardMod("Cowgirl", Vector.<String>(["Female", "Base", "Standard"]), timelineData, dispInfo, "Female (Standard)", true, "Female (taker) animations for the Cowgirl position");
