package
{
	import Pch.Anim2_PeachAnimation;
	import Ros.Anim2_RosalinaAnimation;
    ...
    public class Anim2Animation extends ModArchive
    {
        public function Anim2Animation()
        {
            modsList[modsList.length] = CreateShardModForMale();
			modsList[modsList.length] = CreateShardModForFemale();
			modsList = modsList.concat(Anim2_PeachAnimation.GetShardMods(), Anim2_RosalinaAnimation.GetShardMods());
        }
...
dispInfo[dispInfo.length] = new DispObjInfo("PenisHighlight", 600, 0, "ShaftMask", DispObjInfo.FLAG_MASKED);
        ...
        {
            var dispInfo:Vector.<DispObjInfo> = new Vector.<DispObjInfo>();
dispInfo[dispInfo.length] = new DispObjInfo("BehindBackLayer", 200, 0);
...
dispInfo[dispInfo.length] = new DispObjInfo("EyebrowR", 8800, 0);
dispInfo[dispInfo.length] = new DispObjInfo("EyebrowL", 9000, 0);
...
dataForTimelineCreation.push(new ArmLTimelineData().GetTimelineData());
		...
		private function CreateShardModForMale():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Male (Standard)", true, "Put description here");
            return animateShard;
        }
		...
		private function CreateShardModForFemale():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Female (Standard)", true, "Put description here");
            return animateShard;
        }
