package Pch
{
    ...
    public class Anim2_PeachAnimation
    {
...
dispInfo[dispInfo.length] = new DispObjInfo("EarringR", 1200, 0, "BehindEarLayer", DispObjInfo.FLAG_CHILD);
        ...
        {
            var dispInfo:Vector.<DispObjInfo> = new Vector.<DispObjInfo>();
//dispInfo[dispInfo.length] = new DispObjInfo("Symbol 47", 800, 0, "BehindEarLayer", DispObjInfo.FLAG_CHILD);
            return dispInfo;
        }
...
dispInfo[dispInfo.length] = new DispObjInfo("Grin", 400, 0, "MouthLayer", DispObjInfo.FLAG_CHILD);
            return dispInfo;
        }

		private static function CreateDisplayInfoForTest():Vector.<DispObjInfo>
        {
            var dispInfo:Vector.<DispObjInfo> = new Vector.<DispObjInfo>();
...
dataForTimelineCreation.push(new GrinTimelineData().GetTimelineData());
dataForTimelineCreation.push(new ClosedSmileTimelineData().GetTimelineData());
		...
		private static function CreateShardModForHair():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Peach", "Hair", "Standard"]), timelineData, dispInfo, "Peach Hair", false, "Adds Peach's hair onto the character.");
            return animateShard;
        }
		...
		private static function CreateShardModForHeadwear():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Headwear", "Crown", "Peach", "Rosalina", "Standard"]), timelineData, dispInfo, "Crown", false, "Adds an crown on top of the character's head, slighty obscured by their hair. Intended for the crown of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringL():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Earring", "Left", "Standard"]), timelineData, dispInfo, "Left Earring", false, "Adds an earring for the left ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Earring", "Left", "Standard"]), timelineData, dispInfo, "Right Earring", false, "Adds an earring for the right ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEyeL():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Peach", "Eye", "Left", "Standard", "Standard"]), timelineData, dispInfo, "Left Eye Variant 1", false, "Eye Motion: Looking slightly down > Closed > Looking ahead. Originally used for Peach's default animation.");
            return animateShard;
        }
		...
		private static function CreateShardModForEyeR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Peach", "Eye", "Right", "Standard"]), timelineData, dispInfo, "Right Eye Variant 1", false, "Eye Motion: Looking slightly down > Closed > Looking ahead. Originally used for Peach's default animation.");
            return animateShard;
        }
		...
		private static function CreateShardModForMouth():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim2", Vector.<String>(["Peach", "Mouth", "Standard"]), timelineData, dispInfo, "Mouth Variant 1", false, "Mouth Motion: Closed Smile > Toothy Grin. Originally used for Peach's default animation.");
            return animateShard;
        }
