package Ros 
{
	...
	public class ClosedLashLTimelineData extends TimelineDefinition
	{
		public function ClosedLashLTimelineData()
		{
			...
			tweenPropVector[tweenPropVector.length]= {duration:59,visible:true,transformMatrix:{a:1.1339111328125,b:0.000213623046875,c:-0.0000152587890625,d:-1.0782318115234375,tx:180.5,ty:240.95}};
			tweenPropVector[tweenPropVector.length]= {duration:1,transformMatrix:{a:1.1339111328125,b:0.000213623046875,c:-0.0000152587890625,d:-1.0782318115234375,tx:180.5,ty:246.85}};
