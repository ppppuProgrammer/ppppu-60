package Ros
{
	...
	public class ClosedLashRTimelineData extends TimelineDefinition
	{
		public function ClosedLashRTimelineData()
		{
			...
			tweenPropVector[tweenPropVector.length]= {duration:59,visible:true,transformMatrix:{a:-1.123291015625,b:0.0056304931640625,c:-0.0000152587890625,d:-1.0782318115234375,tx:299.2,ty:240}};
			tweenPropVector[tweenPropVector.length]= {duration:1,transformMatrix:{a:-1.123291015625,b:0.0056304931640625,c:-0.0000152587890625,d:-1.0782318115234375,tx:299.1,ty:245.5}};
			...
			tweenPropVector[tweenPropVector.length]= {duration:1,visible:false,transformMatrix:{a:-1.07830810546875,b:0.0046844482421875,c:-0.0000152587890625,d:-0.8970489501953125,tx:297.15,ty:203.5}};
