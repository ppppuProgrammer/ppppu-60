package Pch
{
    ...
    public class Paizuri_PeachAnimation
    {
        /*public static function Paizuri_PeachAnimation()
        {
...
dataForTimelineCreation.push(new ClosedLashRTimelineData().GetTimelineData());
		...
		private static function CreateShardModForHair():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Paizuri", Vector.<String>(["Peach", "Hair", "Standard"]), timelineData, dispInfo, "Peach Hair", false, "Adds Peach's hair onto the character.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringL():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Paizuri", Vector.<String>(["Earring", "Left", "Standard"]), timelineData, dispInfo, "Left Earring", false, "Adds an earring for the left ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Paizuri", Vector.<String>(["Earring", "Right", "Standard"]), timelineData, dispInfo, "Right Earring", false, "Adds an earring for the right ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
