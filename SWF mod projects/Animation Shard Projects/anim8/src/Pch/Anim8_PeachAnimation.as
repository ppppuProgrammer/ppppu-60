package Pch
{
    ...
    public class Anim8_PeachAnimation
    {
       /* public static function Anim8_PeachAnimation()
        {
...
dispInfo[dispInfo.length] = new DispObjInfo("EarringR", 200, 0, "FrontEarLayer", DispObjInfo.FLAG_CHILD);
        ...
        {
            var dispInfo:Vector.<DispObjInfo> = new Vector.<DispObjInfo>();
dispInfo[dispInfo.length] = new DispObjInfo("ScleraL", 200, 0, "LeftEyeLayer", DispObjInfo.FLAG_CHILD);
...
dispInfo[dispInfo.length] = new DispObjInfo("EyeMaskL", 400, 0, "LeftEyeLayer", DispObjInfo.FLAG_CHILD);
dispInfo[dispInfo.length] = new DispObjInfo("EyelashL", 600, 0, "LeftEyeLayer", DispObjInfo.FLAG_CHILD);
            return dispInfo;
        }
        ...
        {
            var dispInfo:Vector.<DispObjInfo> = new Vector.<DispObjInfo>();
dispInfo[dispInfo.length] = new DispObjInfo("ScleraR", 200, 0, "RightEyeLayer", DispObjInfo.FLAG_CHILD);
...
dispInfo[dispInfo.length] = new DispObjInfo("EyeMaskR", 400, 0, "RightEyeLayer", DispObjInfo.FLAG_CHILD);
dispInfo[dispInfo.length] = new DispObjInfo("EyelashR", 600, 0, "RightEyeLayer", DispObjInfo.FLAG_CHILD);
            return dispInfo;
        }
        ...
        {
            var dispInfo:Vector.<DispObjInfo> = new Vector.<DispObjInfo>();
dispInfo[dispInfo.length] = new DispObjInfo("TeardropMouth", 200, 0, "MouthLayer", DispObjInfo.FLAG_CHILD);
            return dispInfo;
        }
...
dataForTimelineCreation.push(new TeardropMouthTimelineData().GetTimelineData());
		...
		private static function CreateShardModForHair():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Peach", "Hair", "Standard"]), timelineData, dispInfo, "Peach Hair", false, "Adds Peach's hair onto the character.");
            return animateShard;
        }
		...
		private static function CreateShardModForHeadwear():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Headwear", "Crown", "Peach", "Rosalina", "Standard"]), timelineData, dispInfo, "Crown", false, "Adds an crown on top of the character's head, slighty obscured by their hair. Intended for the crown of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringL():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Earring", "Left", "Standard"]), timelineData, dispInfo, "Left Earring", false, "Adds an earring for the left ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Earring", "Left", "Standard"]), timelineData, dispInfo, "Right Earring", false, "Adds an earring for the right ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEyeL():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Peach", "Eye", "Left", "Standard"]), timelineData, dispInfo, "Left Eye Variant 1", false, "Eye Motion: Looking slightly down > Closed > Looking ahead. Originally used for Peach's default animation.");
            return animateShard;
        }
		...
		private static function CreateShardModForEyeR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Right Eye Variant 1", false, "Put description here");
            return animateShard;
        }
		...
		private static function CreateShardModForMouth():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim8", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Mouth Variant 1", false, "Put description here");
            return animateShard;
        }
