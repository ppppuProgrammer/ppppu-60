package Pch
{
    ...
    public class Anim9_PeachAnimation
    {
       /* public static function Anim9_PeachAnimation()
        {
...
dispInfo[dispInfo.length] = new DispObjInfo("OhMouth", 400, 0, "MouthLayer", DispObjInfo.FLAG_CHILD);
            return dispInfo;
        }
...
dataForTimelineCreation.push(new ClosedLashRTimelineData().GetTimelineData());
        ...
        {
            var dataForTimelineCreation:Vector.<Object> = new Vector.<Object>();
dataForTimelineCreation.push(new OhMouthTimelineData().GetTimelineData());
dataForTimelineCreation.push(new ClosedSmileTimelineData().GetTimelineData());
		...
		private static function CreateShardModForHair():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim9", Vector.<String>(["Peach", "Hair"]), timelineData, dispInfo, "Peach Hair", false, "Adds Peach's hair onto the character.");
            return animateShard;
        }
		...
		private static function CreateShardModForHeadwear():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim9", Vector.<String>(["Headwear", "Crown", "Peach", "Rosalina"]), timelineData, dispInfo, "Crown", false, "Adds an crown on top of the character's head, slighty obscured by their hair. Intended for the crown of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringL():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim9", Vector.<String>(["Earring", "Left"]), timelineData, dispInfo, "Left Earring", false, "Adds an earring for the left ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
		...
		private static function CreateShardModForEarringR():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim9", Vector.<String>(["Earring", "Right"]), timelineData, dispInfo, "Right Earring", false, "Adds an earring for the left ear. Intended for the earrings of Peach or Rosalina.");
            return animateShard;
        }
