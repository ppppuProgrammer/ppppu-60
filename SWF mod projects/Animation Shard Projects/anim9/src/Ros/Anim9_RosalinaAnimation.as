package Ros
{
    ...
    public class Anim9_RosalinaAnimation
    {
        /*public static function Anim9_RosalinaAnimation()
        {
...
dataForTimelineCreation.push(new ClosedSmileTimelineData().GetTimelineData());
		...
		private static function CreateShardModForHair():AnimateShardMod
        {
            ...
            var animateShard:AnimateShardMod = new AnimateShardMod("Anim9", Vector.<String>(["Categories", "Here", "Standard"]), timelineData, dispInfo, "Rosalina Hair", false, "Put description here");
            return animateShard;
        }
