package
{
	...
	public class BaseAssetsArchive extends ModArchive 
	{
		...
		public function BaseAssetsArchive() 
		{
			...
			/* Hair */
			modsList[modsList.length] = new AssetsMod(new PchHair1, "PchHair1R" );
			modsList[modsList.length] = new AssetsMod(new PchHair1, "PchHair1L");
			modsList[modsList.length] = new AssetsMod(new PchHair2, "PchHair2L");
			modsList[modsList.length] = new AssetsMod(new PchHair2, "PchHair2R");
			modsList[modsList.length] = new AssetsMod(new PchHair3, "PchHair3L");
			modsList[modsList.length] = new AssetsMod(new PchHair3, "PchHair3R");
			modsList[modsList.length] = new AssetsMod(new PchHairFront, "PchHairFront");
			modsList[modsList.length] = new AssetsMod(new PchHairFrontAngled2, "PchHairFrontAngled2");
			modsList[modsList.length] = new AssetsMod(new PchHairBack, "PchHairBack");
			modsList[modsList.length] = new AssetsMod(new PchEarring, "PchEarringL");
			modsList[modsList.length] = new AssetsMod(new PchEarring, "PchEarringR");
			modsList[modsList.length] = new AssetsMod(new PchCrown, "PchCrown");
			
			modsList[modsList.length] = new AssetsMod(new RosaHair1, "RosaHair1R" );
			modsList[modsList.length] = new AssetsMod(new RosaHair1, "RosaHair1L");
			modsList[modsList.length] = new AssetsMod(new RosaHair2, "RosaHair2L");
			modsList[modsList.length] = new AssetsMod(new RosaHair2, "RosaHair2R");
			modsList[modsList.length] = new AssetsMod(new RosaHair3, "RosaHair3L");
			modsList[modsList.length] = new AssetsMod(new RosaHair3, "RosaHair3R");
			modsList[modsList.length] = new AssetsMod(new RosaHairFront, "RosaHairFront");
			modsList[modsList.length] = new AssetsMod(new RosaHairBack, "RosaHairBack");
			modsList[modsList.length] = new AssetsMod(new RosaEarring, "RosaEarringL");
			modsList[modsList.length] = new AssetsMod(new RosaEarring, "RosaEarringR");
			modsList[modsList.length] = new AssetsMod(new RosaCrown, "RosaCrown");
			modsList[modsList.length] = new AssetsMod(new RosaHairFrontAngled, "RosaHairFrontAngled");
