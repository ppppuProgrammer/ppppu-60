 ...
 */
	public class StarlingTransformMatrixPlugin extends TweenPlugin {
		/** @private **/
		...
		/** @private **/
		//protected var _matrixRef:Matrix;
		/** @private **/
		...
		/** @private **/
		public function StarlingTransformMatrixPlugin() {
		...
		override public function _onInitTween(target:Object, value:*, tween:TweenLite):Boolean {
			_target = target;
			_matrix = target.transformationMatrix as Matrix;
		...
		override public function setRatio(v:Number):void {
			...
			//_matrixRef = _matrix;
			_target.transformationMatrix = _matrix;
		}
