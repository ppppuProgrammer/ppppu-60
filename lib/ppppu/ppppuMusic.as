package ppppu
{
	...
	public class ppppuMusic
	{
		...
		public function ppppuMusic(sourceSound:Sound, musicTitle:String, loopStartPoint:Number = 0, loopEndPoint:Number = -1, musicStartPoint:Number = 0)
		{
			m_title = musicTitle;
		...
		public function Equals(comparedPpppuMusicObject:ppppuMusic):Boolean
		{
